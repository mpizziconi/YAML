...
Il presente documento ha lo scopo di definire le specifiche di interfaccia con i sistemi che interoperano con il nuovo sistema di digitalizzazione appalti che si articola in: Nuova Piattaforma Appalti (NPA) e del suo componente Fascicolo Virtuale dell’Operatore Economico (FVOE).

La NPA costituisce la piattaforma centrale nel sistema nazionale di e-procurement e, assolve ai compiti di:
  - Pubblicità legale dei bandi e degli avvisi di gara in ambito nazionale e comunitario
  - Gestione della pianificazione degli appalti
  - Erogazione del CIG per le procedure di gara
  - Monitoraggio del ciclo di vita dell'appalto
La NPA concentra i servizi prima erogati da diversi soggetti:
  - Il Servizio Contratti Pubblici (MIT) per la pubblicità della pianificazione degli appalti
  - la Gazzetta Ufficiale della Repubblica Italiana come strumento per la pubblicità legale nazionale legata agli appalti pubblici
  - Simog e SmartCig, per l'erogazione del CIG

E' previsto inoltre il servizio di eSender Nazionale TED come strumento per la pubblicità legale comunitaria legata agli appalti pubblici

Il sistema FVOE è un componente della NPA che gestisce il Fadscicolo Virtuale dell'Operatore Economico ed eroga i servizi:
  - Raccolta delle informazioni e della documentazione necessaria alla verifica dei requisiti posseduti dall'operatore economico 
  ...
  - Pubblicazione dell'Elenco degli Operatori Economici Verificati


# 4	Architettura generale 
La nuova piattaforma integrata mira a digitalizzare i processi dell’intero ciclo di vita dell’appalto, attraverso la realizzazione di una serie di strumenti che abilitano l’integrazione e l’interoperabilità tra le piattaforme telematiche presenti nell’ecosistema nazionale dell’e-procurement.
